...
public class SceneLevel2 extends GameObject implements Scene {

    @Override
    public void init() {
        SceneLevel2 sceneLevel2 = GameObjectManager.instance.recycle(SceneLevel2.class);
        sceneLevel2.configAction();
    }
                ...
                new SequenceAction(
                        new ActionAdapter() {
                            ...
                            public boolean run(GameObject owner) {
                                ...
                                image.renderer = new ImageRenderer("resources/images/level2.png", 263, 84);
                        ...
                        new ActionAdapter() {
                            @Override
                            public boolean run(GameObject owner) {
                                SceneManager.instance.changeScene(new GamePlayLevel2Scene());
                                return true;
                            }
                        }
                )
